({
    ...
    getTableData1: function(component, filters, lCycle, brand, startDt, endDt, strType, strGBU) {
        document.getElementById("Accspinner1").style.display = "block";
        var actionData = component.get("c.loadTableData");	//loadData1
        var cats = filters;
        var lcycle = lCycle;
        var brandval = brand;
        var startDtVal = startDt;
        var endDtVal = endDt;
        //alert('getTableData1=='+filters+'***'+lCycle+'***'+brand+'***' + startDt + '***' + endDt+'***'+strType);
        ...
        actionData.setCallback(this, function(df) {
            ...
            if (stateData == "SUCCESS") {
                ...
                if (!$A.util.isEmpty(dataResults) && !$A.util.isUndefined(dataResults)) {
                    ...
                    var ehlength = dataResults['Future Projections'].headWrap;
                    if(ehlength.length <9)
                    {
                    	component.set("v.className","tableTRHeight");
                    }
                    
                    ehlength = dataResults['Actuals'].headWrap;
                    if(ehlength.length <9)
                    {
                    	component.set("v.AclassName","tableTRHeight");
                    }
                    ...
                    for (var kk = 0; kk < dataLResults.length; kk++) {
                        ...
                        var strCategory = dataLResults[kk].strCategory;
                        if(strCategory == 'Aircare')
                        {
                        	strCategory = 'Air Care';
                        }
                        else if(strCategory == 'Dishcare')
                        {
                        	strCategory = 'Dish Care';
                        }else if(strCategory == 'Surfacecare')
                        {
                        	strCategory = 'Surface Care';
                        }
                        
                        if(opt!=null && opt.length>0)
                        {
	                        custs.push({
	                            name: 'Actuals~'+strCategory + '~A & P',
                    ...
                    for (var kk = 0; kk < dataPResults.length; kk++) {
                        ...
                        var strCategory = dataPResults[kk].strCategory;
                        if(strCategory == 'Aircare')
                        {
                        	strCategory = 'Air Care';
                        }
                        ...
                        {
	                        custs.push({
	                            name: 'Projections~'+strCategory + '~A & P',
                        ...
                        {
	                        custs.push({
	                            name: 'Projections~'+strCategory + '~R & H',
	                            color: dataPResults[kk].color,
	                            lineColor: dataPResults[kk].lineColor,
	                            data: opt1
	                        });
                   ...
                   new Highcharts.Chart({
                    ...
                    for (var kk = 0; kk < furuteDataResults.length; kk++) {
                        ...
                        var strCategory = furuteDataResults[kk].strCategory;
                        if(strCategory == 'Aircare')
                        {
                        	strCategory = 'Air Care';
                        }
